...
btncorbaseazul.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#DCD8CC");
  document.getElementById('CB').style.backgroundColor = "#DCD8CC";
});    
//base vermelha
const btncorbasevermelha = document.getElementById('redbase');
btncorbasevermelha.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#968979");
  document.getElementById('CB').style.backgroundColor = "#968979";
});  
//base amarela
const btncorbaseamarela = document.getElementById('yellowbase');
btncorbaseamarela.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#2C8373");
  document.getElementById('CB').style.backgroundColor = "#2C8373";
});  
//base verde
const btncorbaseverde = document.getElementById('greenbase');
btncorbaseverde.addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#829BB4");
  document.getElementById('CB').style.backgroundColor = "#829BB4";
});  

document.getElementById('base1').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#204E8A");
  document.getElementById('CB').style.backgroundColor = "#204E8A";
});  
document.getElementById('base2').addEventListener('click', function(e){
  document.querySelectorAll(".corbase").forEach(v => v.style.fill = "#4F5551");
  document.getElementById('CB').style.backgroundColor = "#4F5551";
});  
  ...
  btncorbotoesazul.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#DCD8CC";
    document.getElementById('BT').style.backgroundColor = "#DCD8CC";
  });    
  //botoes vermelha
  const btncorbotoesvermelha = document.getElementById('redbase1');
  btncorbotoesvermelha.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#968979";
    document.getElementById('BT').style.backgroundColor = "#968979";
  });  
  //botoes amarela
  const btncorbotoesamarela = document.getElementById('yellowbase1');
  btncorbotoesamarela.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#2C8373";
    document.getElementById('BT').style.backgroundColor = "#2C8373";
  });  
  //botoes verde
  const btncorbotoesverde = document.getElementById('greenbase1');
  btncorbotoesverde.addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#829BB4";
    document.getElementById('BT').style.backgroundColor = "#829BB4";
  });  

  document.getElementById('base11').addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#204E8A";
    document.getElementById('BT').style.backgroundColor = "#204E8A";
  });  
  document.getElementById('base21').addEventListener('click', function(e){
    document.getElementById('botao').style.fill = "#4F5551";
    document.getElementById('BT').style.backgroundColor = "#4F5551";
  });  
  ...
  btncorgolaEazul.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#DCD8CC";
    document.getElementById('golaEE').style.fill = "#DCD8CC";
    document.getElementById('ge').style.backgroundColor = "#DCD8CC";
  });    
  ...
  btncorgolaEvermelha.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#968979";
    document.getElementById('golaEE').style.fill = "#968979";
    document.getElementById('ge').style.backgroundColor = "#968979";
  });  
  ...
  btncorgolaEamarela.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#2C8373";
    document.getElementById('golaEE').style.fill = "#2C8373";
    document.getElementById('ge').style.backgroundColor = "#2C8373";
  });  
  //Gola exterior verde
  const btncorgolaEverde = document.getElementById('greenbase2');
  btncorgolaEverde.addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#829BB4";
    document.getElementById('golaEE').style.fill = "#829BB4";
    document.getElementById('ge').style.backgroundColor = "#829BB4";
  });  
  document.getElementById('base12').addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#204E8A";
    document.getElementById('golaEE').style.fill = "#204E8A";
    document.getElementById('ge').style.backgroundColor = "#204E8A";
  });  
  document.getElementById('base22').addEventListener('click', function(e){
    document.getElementById('golaE').style.fill = "#4F5551";
    document.getElementById('golaEE').style.fill = "#4F5551";
    document.getElementById('ge').style.backgroundColor = "#4F5551";
  });  
  ...
  btncorgolaIazul.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#DCD8CC";
    document.getElementById('gi').style.backgroundColor = "#DCD8CC";
  });    
  ...
  btncorgolaIvermelha.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#968979";
    document.getElementById('gi').style.backgroundColor = "#968979";
  });  
  ...
  btncorgolaIamarela.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#2C8373";
    document.getElementById('gi').style.backgroundColor = "#2C8373";
  });  
  //Gola interior verde
  const btncorgolaIverde = document.getElementById('greenbase3');
  btncorgolaIverde.addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#829BB4";
    document.getElementById('gi').style.backgroundColor = "#829BB4";
  });  
  document.getElementById('base13').addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#204E8A";
    document.getElementById('gi').style.backgroundColor = "#204E8A";
  });  
  document.getElementById('base23').addEventListener('click', function(e){
    document.getElementById('golaI').style.fill = "#4F5551";
    document.getElementById('gi').style.backgroundColor = "#4F5551";
  });  
...
//punho branca
  ...
  btncorpunhoazul.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#DCD8CC";
    document.getElementById('punho1').style.fill = "#DCD8CC";
    document.getElementById('PU').style.backgroundColor = "#DCD8CC";
  });    
  //punho vermelha
  const btncorpunhovermelha = document.getElementById('redbase4');
  btncorpunhovermelha.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#968979";
    document.getElementById('punho1').style.fill = "#968979";
    document.getElementById('PU').style.backgroundColor = "#968979";
  });  
  //punho amarela
  const btncorpunhoamarela = document.getElementById('yellowbase4');
  btncorpunhoamarela.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#2C8373";
    document.getElementById('punho1').style.fill = "#2C8373";
    document.getElementById('PU').style.backgroundColor = "#2C8373";
  });  
  //punho verde
  const btncorpunhoverde = document.getElementById('greenbase4');
  btncorpunhoverde.addEventListener('click', function(e){
    document.getElementById('punho2').style.fill = "#829BB4";
    document.getElementById('punho1').style.fill = "#829BB4";
    document.getElementById('PU').style.backgroundColor = "#829BB4";
  });
  ...
  btncorvistaEazul.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#DCD8CC";
    document.getElementById('VE').style.backgroundColor = "#DCD8CC";
  });    
  //vistaE vermelha
  const btncorvistaEvermelha = document.getElementById('redbase5');
  btncorvistaEvermelha.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#968979";
    document.getElementById('VE').style.backgroundColor = "#968979";
  });  
  //vistaE amarela
  const btncorvistaEamarela = document.getElementById('yellowbase5');
  btncorvistaEamarela.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#2C8373";
    document.getElementById('VE').style.backgroundColor = "#2C8373";
  });  
  //vistaE verde
  const btncorvistaEverde = document.getElementById('greenbase5');
  btncorvistaEverde.addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#829BB4";
    document.getElementById('VE').style.backgroundColor = "#829BB4";
  });

  document.getElementById('base15').addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#204E8A";
    document.getElementById('VE').style.backgroundColor = "##204E8A";
  });
  document.getElementById('base25').addEventListener('click', function(e){
    document.getElementById('vista2').style.fill = "#4F5551";
    document.getElementById('VE').style.backgroundColor = "#4F5551";
  });
  ...
  btncorvistaDazul.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#DCD8CC";
    document.getElementById('VD').style.backgroundColor = "#DCD8CC";
  });    
  //vistaD vermelha
  const btncorvistaDvermelha = document.getElementById('redbase6');
  btncorvistaDvermelha.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#968979";
    document.getElementById('VD').style.backgroundColor = "#968979";
  });  
  //vistaD amarela
  const btncorvistaDamarela = document.getElementById('yellowbase6');
  btncorvistaDamarela.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#2C8373";
    document.getElementById('VD').style.backgroundColor = "#2C8373";
  });  
  //vistaD verde
  const btncorvistaDverde = document.getElementById('greenbase6');
  btncorvistaDverde.addEventListener('click', function(e){
    document.getElementById('vista3').style.fill = "#829BB4";
    document.getElementById('VD').style.backgroundColor = "#829BB4";
  });
  ...
  btncorbolsoFazul.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#DCD8CC";
    document.getElementById('BSF').style.backgroundColor = "#DCD8CC";
  });    
  ...
  btncorbolsoFvermelha.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#968979";
    document.getElementById('BSF').style.backgroundColor = "#968979";
  });  
  //Bolso Faixa amarela
  const btncorbolsoFamarela = document.getElementById('yellowbase7');
  btncorbolsoFamarela.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#2C8373";
    document.getElementById('BSF').style.backgroundColor = "#2C8373";
  });  
  //Bolso Faixa verde
  const btncorbolsoFverde = document.getElementById('greenbase7');
  btncorbolsoFverde.addEventListener('click', function(e){
    document.getElementById('bolsofaixa').style.fill = "#829BB4";
    document.getElementById('BSF').style.backgroundColor = "#829BB4";
  });
  ...
  btncorbolsoBazul.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#DCD8CC";
    document.getElementById('BB').style.backgroundColor = "#DCD8CC";
  });    
  //Bolso Faixa vermelha
  const btncorbolsoBvermelha = document.getElementById('redbase8');
  btncorbolsoBvermelha.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#968979";
    document.getElementById('BB').style.backgroundColor = "#968979";
  });  
  //Bolso Faixa amarela
  const btncorbolsoBamarela = document.getElementById('yellowbase8');
  btncorbolsoBamarela.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#2C8373";
    document.getElementById('BB').style.backgroundColor = "#2C8373";
  });  
  //Bolso Faixa verde
  const btncorbolsoBverde = document.getElementById('greenbase8');
  btncorbolsoBverde.addEventListener('click', function(e){
    document.getElementById('bolso12').style.fill = "#829BB4";
    document.getElementById('BB').style.backgroundColor = "#829BB4";
  });
